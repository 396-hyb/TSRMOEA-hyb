...
% 在第一阶段，根据每个权重向量上指标判断解是否存档
    ...
    methods
        function main(Algorithm,Problem)
            ...
            %% Parameter setting
            [eta, ArchGEN, gap, lambda] = Algorithm.ParameterSet(0.5, 30, 20, 1e-3);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                if length(find(flag == 1)) == Problem.N || Problem.FE >= Problem.maxFE  %所有小区域的指标都小于lambda，则开始切换。
