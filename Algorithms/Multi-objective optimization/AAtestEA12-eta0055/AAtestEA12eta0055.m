classdef AAtestEA12eta0055 < ALGORITHM
...
%二阶段占比0.2进化代数
    ...
    methods
        function main(Algorithm,Problem)
            ...
            %% Parameter setting
            [eta, ArchGEN, gap, lambda] = Algorithm.ParameterSet(0.1, 30, 30, 1e-3);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                if length(find(flag == 0)) == 0 || Problem.FE >= Problem.maxFE * 0.8  %所有小区域的指标都小于lambda，则开始切换。
                    disp(["**Problem.FE:",num2str(Problem.FE)]);
               
                    guideGEN = (Problem.maxFE / Problem.N) * 0.2;

                    Population = Final(Problem,IndexArr,ObjsArch,DecsArch,ArchGEN,W,Z,eta,Population,guideGEN);
